 ...
 */
#define LAI_REDIS_KEY_CONTEXT_CONFIG              "LAI_REDIS_CONTEXT_CONFIG"

/**
 * @brief Default synchronous operation response timeout in milliseconds.
 */
#define LAI_REDIS_DEFAULT_SYNC_OPERATION_RESPONSE_TIMEOUT (17*1000)

typedef enum _lai_redis_notify_syncd_t
{
    LAI_REDIS_NOTIFY_SYNCD_INIT_VIEW,

    LAI_REDIS_NOTIFY_SYNCD_APPLY_VIEW,

    LAI_REDIS_NOTIFY_SYNCD_INSPECT_ASIC

} lai_redis_notify_syncd_t;

typedef enum _lai_redis_communication_mode_t
{
    /**
     * @brief Asynchronous mode using Redis DB.
     */
    LAI_REDIS_COMMUNICATION_MODE_REDIS_ASYNC,

    /**
     * @brief Synchronous mode using Redis DB.
     */
    LAI_REDIS_COMMUNICATION_MODE_REDIS_SYNC,

} lai_redis_communication_mode_t;

typedef enum _lai_redis_linecard_attr_t
{
    /**
     ...
     * @default true
     */
    LAI_REDIS_LINECARD_ATTR_RECORD = LAI_LINECARD_ATTR_CUSTOM_RANGE_START,

    /**
     * @brief Will notify syncd whether to init or apply view
     *
     * @type lai_redis_notify_syncd_t
     * @flags CREATE_AND_SET
     * @default LAI_REDIS_NOTIFY_SYNCD_APPLY_VIEW
     */
    LAI_REDIS_LINECARD_ATTR_NOTIFY_SYNCD,
     ...
     * @default false
     */
    LAI_REDIS_LINECARD_ATTR_USE_TEMP_VIEW,
     ...
     * @default false
     */
    LAI_REDIS_LINECARD_ATTR_USE_PIPELINE,
     ...
     * @default empty
     */
    LAI_REDIS_LINECARD_ATTR_RECORDING_OUTPUT_DIR,
     ...
     * when doing log rotate, since lairedis holds handle to recording file for
     ...
     * @default false
     */
    LAI_REDIS_LINECARD_ATTR_PERFORM_LOG_ROTATE,
     ...
     * LAI_REDIS_LINECARD_ATTR_REDIS_COMMUNICATION_MODE.  When set to true it
     * will set LAI_REDIS_LINECARD_ATTR_REDIS_COMMUNICATION_MODE to
     * LAI_REDIS_COMMUNICATION_MODE_REDIS_SYNC.
     *
     ...
     * @default false
     */
    LAI_REDIS_LINECARD_ATTR_SYNC_MODE,

    /**
     * @brief Redis communication mode.
     *
     * @type lai_redis_communication_mode_t
     * @flags CREATE_AND_SET
     * @default LAI_REDIS_COMMUNICATION_MODE_REDIS_ASYNC
     */
    LAI_REDIS_LINECARD_ATTR_REDIS_COMMUNICATION_MODE,

    /**
     * @brief Record statistics counters API calls.
     *
     * Get statistic counters can be queried periodically and can produce a lot
     * of logs in lairedis recording file. There are no OIDs retrieved in those
     ...
     * @default true
     */
    LAI_REDIS_LINECARD_ATTR_RECORD_STATS,
     ...
     * @default 0
     */
    LAI_REDIS_LINECARD_ATTR_CONTEXT,

    /**
     * @brief Recording log filename.
     *
     * Default value is lairedis.rec
     *
     * @type lai_s8_list_t
     * @flags CREATE_AND_SET
     * @default lairedis.rec
     */
    LAI_REDIS_LINECARD_ATTR_RECORDING_FILENAME,
     ...
     * @default 60000
     */
    LAI_REDIS_LINECARD_ATTR_SYNC_OPERATION_RESPONSE_TIMEOUT,

} lai_redis_linecard_attr_t;
