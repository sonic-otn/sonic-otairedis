        ...
        _Out_ uint64_t *count)
{
    ...
    auto strLinecardId = otai_serialize_object_id(linecardId);
...
otai_status_t RedisRemoteOtaiInterface::queryAttributeCapability(
        _In_ otai_object_id_t linecardId,
        _In_ otai_object_type_t objectType,
        ...
        _Out_ otai_attr_capability_t *capability)
{
    ...
    auto linecardIdStr = otai_serialize_object_id(linecardId);
    auto objectTypeStr = otai_serialize_object_type(objectType);
...
otai_status_t RedisRemoteOtaiInterface::waitForQueryAttributeCapabilityResponse(
        _Out_ otai_attr_capability_t* capability)
{
    SWSS_LOG_ENTER();
...
otai_status_t RedisRemoteOtaiInterface::queryAattributeEnumValuesCapability(
        _In_ otai_object_id_t linecardId,
        _In_ otai_object_type_t objectType,
        _In_ otai_attr_id_t attrId,
        _Inout_ otai_s32_list_t *enumValuesCapability)
{
    ...
    auto linecard_id_str = otai_serialize_object_id(linecardId);
...
otai_status_t RedisRemoteOtaiInterface::waitForQueryAattributeEnumValuesCapabilityResponse(
        _Inout_ otai_s32_list_t* enumValuesCapability)
{
    SWSS_LOG_ENTER();
