        ...
        _In_ uint64_t divisor)
{
    ...
    {
        case OTAI_STAT_VALUE_TYPE_UINT32:
            stat.u32 = static_cast<uint32_t>(dividend.u32 / divisor);
            break;

        case OTAI_STAT_VALUE_TYPE_INT32:
            stat.s32 = static_cast<int32_t>(dividend.s32 / divisor);
            break;
        ...
        case OTAI_STAT_VALUE_TYPE_DOUBLE:
            stat.d64 = dividend.d64 / static_cast<double>(divisor);
            break;
...
{
  value.count = static_cast<uint32_t>(s.length());
