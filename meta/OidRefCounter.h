...
namespace laimeta
{
    class OidRefCounter
    {
        ...
        public:
             ...
             */
            std::unordered_map<lai_object_id_t, int32_t> getAllReferences() const;

            std::vector<lai_object_id_t> getAllOids() const;
        ...
        private:
             ...
             */
            std::unordered_map<lai_object_id_t, int32_t> m_hash;
    };
}
