        ...
        _In_ const otai_attribute_t *attr_list)
{
    ...
    if (m_linecardStateMap.find(linecard_id) == m_linecardStateMap.end())
    {
        ...
        {
            case OTAI_VS_LINECARD_TYPE_P230C:
...
otai_status_t VirtualLinecardOtaiInterface::objectTypeGetAvailability(
        _In_ otai_object_id_t linecardId,
        _In_ otai_object_type_t objectType,
        _In_ uint32_t attrCount,
...
otai_status_t VirtualLinecardOtaiInterface::queryAttributeCapability(
        _In_ otai_object_id_t linecard_id,
        _In_ otai_object_type_t object_type,
...
otai_status_t VirtualLinecardOtaiInterface::queryAattributeEnumValuesCapability(
        _In_ otai_object_id_t linecard_id,
        _In_ otai_object_type_t object_type,
        _In_ otai_attr_id_t attr_id,
...
void VirtualLinecardOtaiInterface::syncProcessEventNetLinkMsg(
